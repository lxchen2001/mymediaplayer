...
import com.wsg.kuxuanmedia.base.SuperBaseAdapter;
import com.wsg.kuxuanmedia.domain.SearchBean;
import com.wsg.kuxuanmedia.utils.Constants;
...
public class SearchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    class MyRecognizerDialogListener implements RecognizerDialogListener {
        ...
        public void onResult(RecognizerResult recognizerResult, boolean b) {
            ...
            String text =com.wsg.kuxuanmedia.utils.JsonParser.parseIatResult(result);
            //解析好的
            String sn = null;
            // 读取json结果中的sn字段
            try {
